   ...
   <table border="1" style="width:100%">
       ...
       <c:forEach items="${orderInfo.details}" var="orderDetailInfo">
           <tr>
               ...
               <td>
                <fmt:formatNumber value="${orderDetailInfo.price}" type="currency" currencySymbol="Rs." currencyCode="INR"/>
               </td>
               <td>
                <fmt:formatNumber value="${orderDetailInfo.amount}" type="currency" currencySymbol="Rs." currencyCode="INR"/>
               </td>  
           </tr>
       </c:forEach>
   </table>
